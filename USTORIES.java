...
javax.swing.JList<String> listaArchivos;
...
int filaSeleccionada = -1;
    ...
    public USTORIES() {
        ...
        // RESALTAR ESTADOS EN TABLA DOCENTE
jTable2.setDefaultRenderer(Object.class, new javax.swing.table.DefaultTableCellRenderer() {
    ...
    public java.awt.Component getTableCellRendererComponent(
        ...
        try {
            ...
            if (estado.equalsIgnoreCase("Calificado")) {
                ...
                c.setForeground(java.awt.Color.BLACK);
            } else if (estado.equalsIgnoreCase("Vencido") || estado.equalsIgnoreCase("Vencida")) {
        ...
        listaArchivos = new javax.swing.JList<>(modeloArchivos);
        ...
        if(opcion == JFileChooser.APPROVE_OPTION){
            ...
            if(modeloArchivos.getSize() + archivos.length <= 5){
                for(File archivo : archivos){
                    ...
                    rutasArchivos.add(archivo.getAbsolutePath());
                }
            } else {
...
//llenar datos
    ...
    JOptionPane.showMessageDialog(null, "Error de conexion de base de datos " + e);
}      
